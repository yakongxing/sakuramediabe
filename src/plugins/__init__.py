...
_PUBLIC_EXPORTS = {
    ...
    "MovieQueryFilters": "src.plugins.types",
    "PluginDownloadCandidate": "src.plugins.types",
    "PluginDownloadResult": "src.plugins.types",
    "PluginDownloadTarget": "src.plugins.types",
    "PluginMediaPresence": "src.plugins.types",
    "PluginMediaSnapshot": "src.plugins.types",
    "PluginCollection": "src.plugins.types",
    "PluginNotification": "src.plugins.types",
